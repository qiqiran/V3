<template>
  <BasicModal v-bind="$attrs" @register="register" title="头像上传" width="800px" :canFullscreen="false" @ok="handleOk" okText="确认">
    <div :class="prefixCls">
        ...
        <div :class="`${prefixCls}-toolbar`">
          ...
          <Space>
            <Tooltip title="重置" placement="bottom">
              <Button preIcon="reload" type="primary" size="small" :disabled="!src" @click="handlerToolbar('reset')" />
            </Tooltip>
            <Tooltip title="逆时针旋转" placement="bottom">
              <Button preIcon="rotate-left" type="primary" size="small" :disabled="!src" @click="handlerToolbar('rotate', -45)" />
            </Tooltip>
            <Tooltip title="顺时针旋转" placement="bottom">
              <Button type="primary" preIcon="rotate-right" size="small" :disabled="!src" @click="handlerToolbar('rotate', 45)" />
            </Tooltip>
            <Tooltip title="水平翻转" placement="bottom">
              <Button type="primary" preIcon="column-width" size="small" :disabled="!src" @click="handlerToolbar('scaleX')" />
            </Tooltip>
            <Tooltip title="垂直翻转" placement="bottom">
              <Button type="primary" preIcon="column-height" size="small" :disabled="!src" @click="handlerToolbar('scaleY')" />
            </Tooltip>
            <Tooltip title="放大" placement="bottom">
              <Button type="primary" preIcon="zoom-in" size="small" :disabled="!src" @click="handlerToolbar('zoom', 0.1)" />
            </Tooltip>
            <Tooltip title="缩小" placement="bottom">
              <Button type="primary" preIcon="zoom-out" size="small" :disabled="!src" @click="handlerToolbar('zoom', -0.1)" />
            </Tooltip>
          </Space>
        </div>
      </div>
