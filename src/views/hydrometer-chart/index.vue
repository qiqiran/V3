  ...
  setup() {
    ...
    onMounted(() => {
      setTimeout(() => {
        ...
        //   y: [65.03, 65.01, 52.7, 52.52, 52.22, 51.08, 48.76, 48.78, 48.54, 47.78, 48.74, 47.88, 45.42, 35.62, 31.42, 32.02, 32.22, 36.42, 35.52, 34.42, 34.32, 35.02, 35.42, 46.32, 49.34, 52.22, 53.12, 67.5],
        ...
        //   // 测速仪入水深度
        //   tz: -2,
        //   x: [-15.0, -11.6, -4.0, 0.0, 0.4, 0.6, 1.2, 7.3, 17.3, 17.4, 17.8, 18.3, 19.3, 20.3, 21.3, 21.8, 22.3, 22.8, 23.3, 23.8, 24.3, 24.8, 25.3, 25.8, 26.3, 26.8, 27.3, 27.8, 28.3, 28.8, 29.3, 29.8, 30.3, 30.8, 31.3, 31.8, 32.3, 32.8, 33.3, 33.8, 34.3, 34.8, 35.3, 35.8, 36.3, 36.8, 37.3, 37.8, 38.3, 38.8, 39.3, 39.8, 40.3, 40.8, 41.3, 42.3, 43.3, 44.3, 45.3, 46.3, 47.3, 48.3, 49.3, 50.3, 51.3, 52.3, 53.3, 54.3, 55.3, 56.3, 56.5, 65.5, 68.3, 69.2, 72.3, 72.4, 79.1, 80.5],
        //   y: [
        //     27.88,
        //     27.83,
        //     27.85,
