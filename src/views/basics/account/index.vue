...
<script lang="ts">
import { defineComponent, onMounted, ref, Ref, toRaw, unref } from "vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const [registerTable, { setLoading, getSelectRowKeys, getRowSelection, setColumns, setSelectedRowKeys, setPagination, getPaginationRef }] = useTable({
      // useSearchForm: true,
      bordered: true,
      // pagination: false,
      columns,
