<template>
  <ScrollContainer class="container">
    <a-row :gutter="[16, 16]">
      ...
      <a-col :xs="24" :xl="12" :xxl="6">
        <a-card>
          <CountTo ref="countTo32Ref" @onFinished="redo()" class="count-to-02" :endVal="99.99" :decimals="2" decimal="." />
        </a-card>
      </a-col>
    </a-row>
    ...
    <a-row :gutter="[16, 16]">
      <a-col :xs="24" :xl="12" :xxl="6">
        <a-card>
          <CountTo class="count-to-01" prefix="距离" suffix="m" :color="'#409EFF'" :startVal="200" :endVal="400" :separator="''" />
        </a-card>
      </a-col>
      <a-col :xs="24" :xl="12" :xxl="6">
        <a-card>
