<template>
  <ScrollContainer :class="[prefixCls, `container`]">
    <a-card title="更换头像">
      <CropperAvatar :value="`static/images/pic/gsx.jpg`" btnText="更换头像" :btnProps="{ preIcon: 'cloud-upload' }" width="250" />
      <!-- :uploadApi="uploadApi" -->
      <!-- @change="updateAvatar" -->
    </a-card>
    ...
    <a-card title="矩形裁剪">
      <div class="section cropper-container">
        <!--  @ready="" -->
        <CropperImage style="height: 100%; width: 1000px" :src="`static/images/pic/zl.jpg`" @cropend="handleCropperCropend" />
    ...
    <a-card title="圆形裁剪">
      <div class="section cropper-container">
        <!--  @ready="" -->
        <CropperImage style="height: 100%; width: 1000px" :src="`static/images/pic/zl.jpg`" @cropend="handleCircleCropend" circled />
